 ...
 */
function sendMessages( $messages, $option = USE_SPECIFIED, $devices = array(), $schedule = null, $useRandomDevice = false ) {
	$url      = SERVER . '/services/send.php';
	$postData = array(
 ...
 * @throws Exception If there is an error while sending messages.
 */
function sendMessageToContactsList( $listID, $message, $option = USE_SPECIFIED, $devices = array(), $schedule = null, $isMMS = false, $attachments = null ) {
	$url      = SERVER . '/services/send.php';
	$postData = array(
		'listID'      => $listID,
		'message'     => $message,
